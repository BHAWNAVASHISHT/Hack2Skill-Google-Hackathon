...
export default function ComplaintDetails() {
  ...
  const { complaints, workers, updateComplaint, profile, t } = useMockStore();
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <main className="flex-1 p-4 sm:p-8 flex flex-col lg:grid lg:grid-cols-12 gap-8 max-w-[1400px] mx-auto w-full mb-12">
         ...
         <div className="lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               <div className="bg-white rounded-[3rem] border border-slate-200 p-8 flex flex-col gap-8 shadow-xl shadow-slate-200/30">
                  <h3 className="font-black text-[10px] text-slate-400 uppercase tracking-[0.3em] flex items-center gap-4">
                     <div className="w-8 h-8 rounded-xl bg-orange-50 flex items-center justify-center"><MapPin className="text-primary w-5 h-5" /></div> {t('photoVideo')}
                  </h3>
                  <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden border border-slate-100 shadow-inner group">
                    {complaint.imageUrl ? (
                      <>
         ...
         <div className="lg:col-span-4 flex flex-col gap-8">
               ...
               <div className="flex flex-col gap-8 pt-10 border-t border-slate-800/50 relative z-10">
                  ...
                  {complaint.workerId ? (
                     <div className="flex items-center gap-5 p-4 rounded-[2rem] bg-slate-900/40 border border-slate-800/50">
                        <div className="w-12 h-12 rounded-2xl bg-slate-800 border border-white/5 flex items-center justify-center text-xs font-black text-primary">OP</div>
                        <div className="flex flex-col gap-1">
                           <div className="font-black text-sm text-white leading-none uppercase tracking-tight">Operator Zero</div>
                           <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest leading-none">Field Command #01</div>
                        </div>
                     </div>
                  ) : (
            ...
            <div className="bg-white rounded-[3.5rem] border border-slate-200 h-[350px] overflow-hidden relative shadow-2xl group border-2">
                {/* Custom Tactical Map Visualization */}
                <div className="absolute inset-0 bg-slate-900 flex items-center justify-center">
                   <img 
                      src="https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=1000&auto=format&fit=crop" 
                      className="w-full h-full object-cover opacity-20 grayscale"
                      alt="Tactical Backdrop"
                   />
