...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-32 flex flex-col items-center text-center relative">
        {/* Background Decor */}
      ...
      <footer className="py-20 px-6 border-t border-slate-200 bg-white">
          ...
          <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-slate-100 flex justify-between items-center text-[10px] font-bold text-slate-400 uppercase tracking-widest">
