           ...
           {showShare && (
             ...
             >
                <motion.div 
                   ...
                   className="bg-white rounded-[3rem] p-10 max-w-md w-full border border-slate-200 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)] flex flex-col gap-8"
                >
                   <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                         <div className="w-10 h-10 bg-slate-900 text-primary rounded-xl flex items-center justify-center">
                            <MessageCircle className="w-5 h-5" />
                         </div>
                         <h3 className="text-lg font-black text-slate-900 uppercase tracking-tight">Signal Draft</h3>
                      </div>
                      <button onClick={() => setShowShare(false)} className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 hover:text-primary transition-colors">
                         <XCircle className="w-6 h-6" />
                      </button>
                   </div>
                   <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 relative overflow-hidden group">
                      <div className="absolute top-3 left-3 opacity-10"><MessageCircle className="w-10 h-10" /></div>
                      <p className="text-slate-800 text-sm leading-relaxed font-semibold italic relative z-10">
                         "{socialPost}"
                      </p>
                   </div>
                   <div className="flex flex-col gap-3">
                      <button className="btn-primary w-full py-4 text-xs tracking-[0.1em]">Copy Intelligence Draft</button>
                      <button className="w-full py-4 text-xs font-black uppercase tracking-widest text-slate-400 hover:text-primary transition-colors">Broadcast to X</button>
                   </div>
                </motion.div>
             </motion.div>
           )}
